...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nodeUuid = __webpack_require__(162);
	...
	var _libsFind_index = __webpack_require__(165);
	
	var _libsFind_index2 = _interopRequireDefault(_libsFind_index);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_Notes2['default'], { items: notes, onEdit: this.itemEdited })
	      );
	    }
	  }, {
	    key: 'addItem',
	    ...
	    key: 'itemEdited',
	    value: function itemEdited(noteId, task) {
	      var notes = this.state.notes;
	      var noteIndex = (0, _libsFind_index2['default'])(notes, 'id', noteId);
	...
	var Notes = (function (_React$Component) {
	  ...
	  _createClass(Notes, [{
	    ...
	    value: function renderNote(note) {
	      return _react2['default'].createElement(
	        'li',
	        { className: 'note', key: 'note' + note.id },
...
/***/ function(module, exports) {
	...
	function findIndex(arr, prop, value) {
	  var o = arr.filter(function (c) {
	    return c[prop] === value;
	  })[0];
	  var ret = o && arr.indexOf(o);
